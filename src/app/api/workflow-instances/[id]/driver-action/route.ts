...
export async function POST(
  ...
  try {
    const result = await recordDriverAction(id, actionKey, actorResult.actorId)
    ...
    if (
      error instanceof InvalidDriverActionError ||
    ...
    console.error(`[workflow instance driver action error] ${id} ${toErrorMessage(error)}`)
